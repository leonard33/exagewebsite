...
const Slider = () => {
  ...
  >
    ...
    <div className='introduction absolute top-20 left-28'>
        ...
        <button className='slider-btn border-2 text-white py-2 px-5 rounded-lg mt-5 hover:bg-orange-500 hover:text-white text-lg font-semibold'>GET IN TOUCH {'>'}{'>'}</button>
        </div>
    ...
    <div className='overlay'></div>
     ...
     <div className='introduction absolute top-20 left-28'>
       <h2>Access Control & CCTV - Solutions!</h2>
        ...
        <button className='slider-btn border-2 py-2 px-5 rounded-lg mt-5 hover:bg-orange-500 hover:text-white text-lg font-semibold'>GET IN TOUCH {'>'}{'>'}</button>
        </div>
